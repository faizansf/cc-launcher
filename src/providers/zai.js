export default {
  ...
  name: 'z.ai',
  fields: [
    { key: 'ANTHROPIC_BASE_URL', label: 'API Base URL', type: 'url', required: true, default: 'https://api.z.ai/api/anthropic' },
    ...
    { key: 'API_TIMEOUT_MS', label: 'Timeout (ms)', type: 'string', required: false, default: '3000000' },
  ]
};
